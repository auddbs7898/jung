    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $board['../../adm/bo_table'] ?>" class="btn_frmline">게시판 바로가기</a>
...
<div class="btn_fixed_top">
    <?php if( $bo_table && $w ){ ?>
        ...
        <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $board['../../adm/bo_table']; ?>" class=" btn_02 btn">게시판 바로가기</a>
