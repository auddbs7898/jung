...
<div class="local_ov01 local_ov">
    <?php if ($page > 1) {?><a href="<?php echo $_SERVER['../../adm/SCRIPT_NAME']; ?>">처음으로</a><?php } ?>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_l">
            ...
            <a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=<?php echo $row['../../adm/co_id']; ?>" class="btn btn_02"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span> 보기</a>
