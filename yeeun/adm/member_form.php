        ...
        <ul class="social_link_box">
            <li class="social_login_container">
                ...
                <div class="account_provider" data-mpno="social_<?php echo $account['mp_no'];?>" >
                    ...
                    <div class="btn_info"><a href="<?php echo G5_SOCIAL_LOGIN_URL.'file:///C|/Users/hi/Desktop/unlink.php'.$account['mp_no'] ?>" class="social_unlink" data-provider="<?php echo $account['mp_no'];?>" >연동해제</a> <span class="sound_only"><?php echo substr($account['mp_register_day'], 2, 14); ?></span></div>
                </div>
                <?php } //end foreach ?>
            </li>
        </ul>
