...
<div id="formmail" class="new_win">
    ...
    <form name="fformmail" action="../../../../../mobile/skin/member/basic/formmail_send.php" onsubmit="return fformmail_submit(this);" method="post" enctype="multipart/form-data" style="margin:0px;">
