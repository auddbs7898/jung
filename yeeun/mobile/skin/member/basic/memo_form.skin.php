...
<div id="memo_write" class="new_win">
    ...
    <ul class="win_ul">
        <li><a href="../../../../../mobile/skin/member/basic/memo.php?kind=recv">받은쪽지</a></li>
        <li><a href="../../../../../mobile/skin/member/basic/memo.php?kind=send">보낸쪽지</a></li>
        <li><a href="../../../../../mobile/skin/member/basic/memo_form.php" class="selected">쪽지쓰기</a></li>
    </ul>
    <form name="fmemoform" action="../../../../../mobile/skin/member/basic/memo_form_update.php" onsubmit="return fmemoform_submit(this);" method="post" autocomplete="off">
    <div class="form_01">
