...
<div id="memo_view" class="new_win">
    ...
    <ul class="win_ul">
        <li><a href="../../../../../mobile/skin/member/basic/memo.php?kind=recv" class="selected">받은쪽지</a></li>
        <li><a href="../../../../../mobile/skin/member/basic/memo.php?kind=send">보낸쪽지</a></li>
    ...
    <div class="new_win_con">
        ...
        <div class="win_btn">
            <?php if ($kind == 'recv') { ?><a href="../../../../../mobile/skin/member/basic/memo_form.php?me_recv_mb_id=<?php echo $mb['mb_id'] ?>&me_id=<?php echo $memo['me_id'] ?>" class="btn_submit">답장</a><?php } ?>
            <?php if($prev_link) { ?>
