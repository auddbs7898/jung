...
<div class="list_01" id="new_list">
    ...
    ?>
    <li>
        <a href="<?php echo $list[$i]['../../../../../mobile/skin/new/basic/href'] ?>" class="new_tit"><?php echo $list[$i]['comment'] ?><?php echo $wr_subject ?></a>
        <a href="../../../../../mobile/skin/new/basic/board.php?bo_table=<?php echo $list[$i]['bo_table'] ?>" class="new_board"><i class="fa fa-list-alt" aria-hidden="true"></i> <?php echo $bo_subject ?></a>
