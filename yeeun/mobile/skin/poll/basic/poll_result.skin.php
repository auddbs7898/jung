...
<div id="poll_result" class="new_win">
    ...
    <div  class="new_win_con">
        ...
        <section id="poll_result_cmt">
            ...
            <form name="fpollresult" method="post" action="../../../../../mobile/skin/poll/basic/poll_etc_update.php" onsubmit="return fpollresult_submit(this);" autocomplete="off">
        ...
        <aside id="poll_result_oth" class="list_01">
            ...
            <ul>
                ...
                <li><a href="../../../../../mobile/skin/poll/basic/poll_result.php?po_id=<?php echo $list3[$i]['po_id'] ?>&skin_dir=<?php echo urlencode($skin_dir); ?>"> <?php echo $list3[$i]['subject'] ?> </a><span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $list3[$i]['date'] ?></span></li>
                <?php }  ?>
            </ul>
        </aside>
