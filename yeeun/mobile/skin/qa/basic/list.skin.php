...
<div id="bo_list">
    ...
    <form name="fqalist" id="fqalist" action="../../../../../mobile/skin/qa/basic/qadelete.php" onsubmit="return fqalist_submit(this);" method="post">
        ...
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_title">
                    ...
                    <a href="<?php echo $list[$i]['../../../../../mobile/skin/qa/basic/view_href']; ?>" class="li_sbj">
