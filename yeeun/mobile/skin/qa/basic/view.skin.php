        ...
        <section id="bo_v_atc">
            ...
            <section id="bo_v_file">
                ...
                for ($i=0; $i<$view['download_count']; $i++) {
                 ?>
                    <li>
                        <a href="<?php echo $view['../../../../../mobile/skin/qa/basic/download_href'][$i];  ?>" class="view_file_download">
            ...
            <?php
                ...
                <li>
                    <div class="li_title">
                        ...
                        <a href="<?php echo $rel_list[$i]['../../../../../mobile/skin/qa/basic/view_href']; ?>" class="li_sbj">
