...
function play()
{
    ...
    var mediaobj = "<embed src='../../../../../../plugin/editor/cheditor5/popup/js/"+file.value+"' autostart='true' loop='true'></embed>";
...
{
    var file = document.getElementById("fm_linkurl");
    var media = "<embed src='../../../../../../plugin/editor/cheditor5/popup/js/"+file.value+"' autostart='true' loop='true'></embed>";
