    ...
    var gnu = {
        ...
        _add : function(e, data, preload){
            ...
            $.each(data.files, function (index, file) {
                ...
                var node = $('<div/>')
                        ...
                        .append($('<span/>').addClass("delete_img").attr({"data-delete":file.name,"data-url":file.url}).html("<img src='../../../../../../../plugin/editor/smarteditor2/photo_uploader/popup/js/img/system_delete.png' alt='삭제' title='삭제' >")),
                    $img = "<img src='../../../../../../../plugin/editor/smarteditor2/photo_uploader/popup/js/img/loading.gif' class='pre_thumb' />",
                    size_text = '';
        ...
        setPhotoToEditor : function(oFileInfo){
            if (!!opener && !!opener.nhn && !!opener.nhn.husky && !!opener.nhn.husky.PopUpManager) {
                ...
                //본문에 바로 tag를 넣는 방법 (oFileInfo는 String으로 <img src=../../../../../../../plugin/editor/smarteditor2/photo_uploader/popup/js/....> )
