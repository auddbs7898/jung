...
(function($) {
     ...
     * your source:
     * 
     * > <script type="text/javascript" src="../../../../plugin/jqplot/plugins/plugins/jqplot.ohlcRenderer.js"></script>
     * 
     * You will most likely want to use a date axis renderer
     * for the x axis also, so include the date axis render js file also:
     * 
     * > <script type="text/javascript" src="../../../../plugin/jqplot/plugins/plugins/jqplot.dateAxisRenderer.js"></script>
     * 
