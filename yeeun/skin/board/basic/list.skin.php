...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <form name="fboardlist" id="fboardlist" action="../../../../skin/board/basic/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                ...
                if ($is_category && $list[$i]['ca_name']) {
                 ?>
                <a href="<?php echo $list[$i]['../../../../skin/board/basic/ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a>
                <?php } ?>
                <div class="bo_tit">
                    
                    <a href="<?php echo $list[$i]['../../../../skin/board/basic/href'] ?>">
