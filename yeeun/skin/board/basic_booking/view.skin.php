...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">예약</span><strong><a href="#bo_vc"> <i class="fa fa-calendar" aria-hidden="true"></i> <span id="booking_count"><?php echo number_format($view['wr_comment']) ?></span>건</a></strong>
