...
<section id="bo_w">
    ...
    <!-- 벌이뉨 마감수 마감날짜 추가 -->
    <div class="bo_w_info write_div">
        <label for="wr_10" class="sound_only">마감수<strong>필수</strong></label>
        <input type="number" name="wr_10" value="<?php echo $wr_10 ?>" id="wr_10" required class="frm_input required" placeholder="마감수">
        <label for="wr_9" class="sound_only">마감날짜<strong>필수</strong></label>
        <input type="text" name="wr_9" value="<?php echo $wr_9 ?>" id="wr_9" required class="frm_input required" placeholder="마감날짜" style="margin: 0 0.5%;">        
    </div>
    <!-- 벌이뉨 마감수 마감날짜 추가 -->
