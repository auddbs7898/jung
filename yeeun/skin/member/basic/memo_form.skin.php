...
<div id="memo_write" class="new_win">
    ...
    <div class="new_win_con">
        <ul class="win_ul">
            <li><a href="../../../../skin/member/basic/memo.php?kind=recv">받은쪽지</a></li>
            <li><a href="../../../../skin/member/basic/memo.php?kind=send">보낸쪽지</a></li>
            <li class="selected"><a href="../../../../skin/member/basic/memo_form.php">쪽지쓰기</a></li>
        </ul>
