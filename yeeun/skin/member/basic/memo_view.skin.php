...
<div id="memo_view" class="new_win">
    ...
    <div class="new_win_con">
        ...
        <div class="win_btn">
            ...
            <?php if ($kind == 'recv') {  ?><a href="../../../../skin/member/basic/memo_form.php?me_recv_mb_id=<?php echo $mb['mb_id'] ?>&me_id=<?php echo $memo['me_id'] ?>" class="btn btn_b02 reply_btn">답장</a><?php }  ?>
        </div>
    </div>
</div>
<!-- } 쪽지보기 끝 -->