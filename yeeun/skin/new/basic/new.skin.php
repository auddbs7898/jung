...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <?php } ?>
        <td class="td_group"><a href="../../../../skin/new/basic/new.php?gr_id=<?php echo $list[$i]['gr_id'] ?>"><?php echo $gr_subject ?></a></td>
        <td class="td_board"><a href="../../../../skin/new/basic/board.php?bo_table=<?php echo $list[$i]['bo_table'] ?>"><?php echo $bo_subject ?></a></td>
        <td><a href="<?php echo $list[$i]['../../../../skin/new/basic/href'] ?>" class="new_tit"><?php echo $list[$i]['comment'] ?><?php echo $wr_subject ?></a></td>
