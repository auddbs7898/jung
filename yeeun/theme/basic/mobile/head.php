...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" class="hd_div">
            ...
            ?>
                <li class="gnb_1dli">
                    <a href="<?php echo $row['../../../../theme/basic/mobile/me_link']; ?>" target="_<?php echo $row['me_target']; ?>" class="gnb_1da"><?php echo $row['me_name'] ?></a>
                    <?php
                    $sql2 = " select *
                                from {$g5['menu_table']}
                                where me_mobile_use = '1'
                    ...
                    ?>
                        <li class="gnb_2dli"><a href="<?php echo $row2['../../../../theme/basic/mobile/me_link']; ?>" target="_<?php echo $row2['me_target']; ?>" class="gnb_2da"><span></span><?php echo $row2['me_name'] ?></a></li>
                    <?php
                    }
