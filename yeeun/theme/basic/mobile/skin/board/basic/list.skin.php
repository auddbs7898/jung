...
<div id="bo_list">
    ...
    <form name="fboardlist" id="fboardlist" action="../../../../../../../theme/basic/mobile/skin/board/basic/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <ul>
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_subject">
                    ...
                    ?>
                    <a href="<?php echo $list[$i]['../../../../../../../theme/basic/mobile/skin/board/basic/ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a>
                    <?php } ?>

                    <a href="<?php echo $list[$i]['../../../../../../../theme/basic/mobile/skin/board/basic/href'] ?>" class="bo_subject">
