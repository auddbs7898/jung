...
<div id="bo_gall">
    ...
    <form name="fboardlist"  id="fboardlist" action="../../../../../../../theme/basic/mobile/skin/board/gallery/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            <div class="gall_li_wr">
                ...
                <a href="<?php echo $list[$i]['../../../../../../../theme/basic/mobile/skin/board/gallery/href'] ?>" class="gall_img">
                <?php
                ...
                <div class="gall_text_href">
                    ...
                    ?>
                    <a href="<?php echo $list[$i]['../../../../../../../theme/basic/mobile/skin/board/gallery/ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a>
                    <?php } ?>
                    <a href="<?php echo $list[$i]['../../../../../../../theme/basic/mobile/skin/board/gallery/href'] ?>" class="gall_li_tit">
