...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_act">
            ...
            <span class="bo_v_act_gng">
                <a href="<?php echo $good_href.'../../../../../../../theme/basic/mobile/skin/board/gallery/&amp;'.$qstr ?>" id="good_button"  class="bo_v_good"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i><br><span class="sound_only">추천</span><strong><?php echo number_format($view['wr_good']) ?></strong></a>
                <b id="bo_v_act_good">이 글을 추천하셨습니다</b>
            </span>
            <?php } ?>
            <?php if ($nogood_href) { ?>
            <span class="bo_v_act_gng">
                <a href="<?php echo $nogood_href.'../../../../../../../theme/basic/mobile/skin/board/gallery/&amp;'.$qstr ?>" id="nogood_button" class="bo_v_nogood"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i><br><span class="sound_only">비추천</span><strong><?php echo number_format($view['wr_nogood']) ?></strong></a>
    ...
    <section id="bo_v_file">
        ...
        for ($i=0; $i<count($view['file']); $i++) {
         ...
         ?>
            <li>
                <a href="<?php echo $view['../../../../../../../theme/basic/mobile/skin/board/gallery/file'][$i]['href'];  ?>" class="view_file_download">
    ...
    <section id="bo_v_link">
        ...
        for ($i=1; $i<=count($view['link']); $i++) {
         ...
         ?>
            <li>
                <a href="<?php echo $view['../../../../../../../theme/basic/mobile/skin/board/gallery/link_href'][$i] ?>" target="_blank">
