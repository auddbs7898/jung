...
<nav id="bo_cate">
    ...
    <ul id="bo_cate_ul">
        ...
        ?>
        <li><a href="<?php echo $category_href;?>?fm_id=<?php echo $v['../../../../../../../theme/basic/mobile/skin/faq/basic/fm_id']?>" <?php echo $category_option;?> ><?php echo $category_msg.$v['fm_subject'];?></a></li>
        <?php
        }
        ?>
    </ul>
