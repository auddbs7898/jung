...
<aside id="poll">
    ...
    <footer>
        ...
        <a href="<?php echo G5_BBS_URL."file:///C|/Users/hi/Desktop/poll_result.php".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn btn_b01">결과보기</a>
    </footer>
</aside>
</form>
