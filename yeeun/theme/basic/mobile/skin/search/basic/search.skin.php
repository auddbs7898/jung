...
<div id="sch_result">
    ...
    if ($stx) {
     ...
     ?>
    <ul id="sch_res_board">
        <li><a href="../../../../../../../theme/basic/mobile/skin/search/basic/?<?php echo $search_query ?>&gr_id=<?php echo $gr_id ?>" <?php echo $sch_all ?>>전체게시판</a></li>
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        <h2><a href="../../../../../../../theme/basic/mobile/skin/search/basic/board.php?bo_table=<?php echo $search_table[$idx] ?>&<?php echo $search_query ?>"><?php echo $bo_subject[$idx] ?> 게시판 내 결과</a></h2>
        <ul>
        <?php
         ...
         ?>
            <li>
                <div  class="sch_res_title">
                    <a href="<?php echo $list[$idx][$i]['../../../../../../../theme/basic/mobile/skin/search/basic/href'] ?><?php echo $comment_href ?>"><?php echo $comment_def ?><?php echo $list[$idx][$i]['subject'] ?></a>
                    <a href="<?php echo $list[$idx][$i]['../../../../../../../theme/basic/mobile/skin/search/basic/href'] ?><?php echo $comment_href ?>" target="_blank" class="sch_res_new"><i class="fa fa-share-square-o" aria-hidden="true"></i><span class="sound_only">새창</span></a>
                </div>
        ...
        <div class="sch_more"><a href="../../../../../../../theme/basic/mobile/skin/search/basic/board.php?bo_table=<?php echo $search_table[$idx] ?>&<?php echo $search_query ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i> <strong><?php echo $bo_subject[$idx] ?></strong> 결과 더보기</a></div>
