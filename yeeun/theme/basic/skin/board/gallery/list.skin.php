...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <form name="fboardlist"  id="fboardlist" action="../../../../../../theme/basic/skin/board/gallery/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img">
                        <a href="<?php echo $list[$i]['../../../../../../theme/basic/skin/board/gallery/href'] ?>">
                        <?php
                    ...
                    <div class="gall_text_href">
                        ...
                        if ($is_category && $list[$i]['ca_name']) {
                         ?>
                        <a href="<?php echo $list[$i]['../../../../../../theme/basic/skin/board/gallery/ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a>
                        <?php } ?>
                        <a href="<?php echo $list[$i]['../../../../../../theme/basic/skin/board/gallery/href'] ?>" class="bo_tit">
