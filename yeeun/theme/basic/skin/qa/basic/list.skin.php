...
<div id="bo_list">
    ...
    <form name="fqalist" id="fqalist" action="../../../../../../theme/basic/skin/qa/basic/qadelete.php" onsubmit="return fqalist_submit(this);" method="post">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['../../../../../../theme/basic/skin/qa/basic/view_href']; ?>" class="bo_tit">
