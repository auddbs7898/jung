            ...
            for ($i=0; $i<$view['download_count']; $i++) {
             ?>
                <li>
                    ...
                    <a href="<?php echo $view['../../../../../../theme/basic/skin/qa/basic/download_href'][$i];  ?>" class="view_file_download">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                <td>
                    ...
                    <a href="<?php echo $rel_list[$i]['../../../../../../theme/basic/skin/qa/basic/view_href']; ?>" class="bo_tit">
