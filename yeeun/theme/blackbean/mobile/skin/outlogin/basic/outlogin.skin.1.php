...
<aside id="ol_before" class="ol">
    <h2>로그인<button type="button" class="hd_closer user_close"><i class="fa fa-times" aria-hidden="true"></i><span class="sound_only">메뉴닫기</span></button></h2>
    <!-- 로그인 전 외부로그인 시작 -->
    ...
    <fieldset>
    	<div class="ol_wr">
	        ...
	        <input type="text" name="mb_id" id="ol_id" required maxlength="20">
	        <span class="ol_tit">비밀번호</span>
	        <input type="password" id="ol_pw" name="mb_password" required  maxlength="20">
	        <div id="ol_auto">
